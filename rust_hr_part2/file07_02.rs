...
//under the hood no>tify aise implment hua h
fn notify<T:Summary + Flksjdf>(item:&T){
    println!("Breaking news! {}",item.summarize());
 }
// <T:Summary> ka matlab h i T ne Summary  qur Flksjdf ko implment karna hona chahiye
// (item : &T), wo paramtere h jo pass ho rahah 